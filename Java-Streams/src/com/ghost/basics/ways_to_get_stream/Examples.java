package com.ghost.basics.ways_to_get_stream;
...
public class Examples {
	...
	public static void main(String[] args) throws IOException {
		// Files.readAllLines(Paths.get("")).forEach(str ->System.out.println(str));;

		// 1
		System.out.println("Obtain stream fon a list");
		Stream<String> stream1 = Arrays.asList("a", "b", "c", "d", "e").stream();
		stream1.forEach(System.out::println);
		System.out.println("-----------------------------------------------------------");

		// 2
		System.out.println("Obtain stream form map");
